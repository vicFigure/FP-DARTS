...
from .search_model_rome   import TinyNetworkROME
from .search_model_prunenas    import TinyNetworkPruneNAS
...
nas201_super_nets = {'DARTS-V1': TinyNetworkDarts,
                     ...
                     "ROME": TinyNetworkROME,
                     "ROME_HPO": TinyNetworkROME,
                     "PruneNAS": TinyNetworkPruneNAS,
                    }
